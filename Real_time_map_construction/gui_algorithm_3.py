...
def draw_cube(map,ycoord,xcoord,local_list,margin=5,block_size=20,color=(100,100,255)):
    ...
    cube_width = (block_size - 2*margin)
    if(dir==0):
        map[yres+margin:yres+margin+cube_width//2,
            xres+margin+cube_width//3:xres+margin+(cube_width//3)*2]=0
    elif(dir==1):
        map[yres+margin+cube_width//3:yres+margin+(cube_width//3)*2,
            xres+margin+cube_width//2:xres+margin+cube_width]=0
    elif(dir==2):
        map[yres+margin+cube_width//2:yres+margin+cube_width,
            xres+margin+cube_width//3:xres+margin+(cube_width//3)*2]=0
    else:
        map[yres+margin+cube_width//3:yres+margin+(cube_width//3)*2,
            xres+margin:xres+margin+cube_width//2]=0
    return(map)
